...
module "foundation" {
  ...
  refresh_scheduler_enabled   = var.refresh_scheduler_enabled
  refresh_scheduler_schedule  = var.refresh_scheduler_schedule
  refresh_scheduler_time_zone = var.refresh_scheduler_time_zone
}
